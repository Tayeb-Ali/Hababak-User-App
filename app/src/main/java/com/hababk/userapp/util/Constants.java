...
public class Constants {
    ...
    public static final String BROADCAST_CART = "com.verbosetech.cookfu.BROADCAST_CART";
    public static final String BROADCAST_ADDRESS = "com.verbosetech.cookfu.BROADCAST_ADDRESS";
}
