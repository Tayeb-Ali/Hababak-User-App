...
import com.hababk.userapp.fragment.FavoriteFragment;
import com.hababk.userapp.fragment.HomeFragment;
import com.hababk.userapp.fragment.MyReviewsFragment;
import com.hababk.userapp.fragment.OrdersFragment;
import com.hababk.userapp.R;
import com.hababk.userapp.fragment.SupportFragment;
import com.hababk.userapp.adapter.DrawerListAdapter;
import com.hababk.userapp.model.CategoryFood;
import com.hababk.userapp.model.NavItem;
...
public class MainActivity extends BaseLocationActivity implements HomeFragment.HomeFragmentInteractor {
    ...
    private final String FRAG_TAG_HOME = "حبابك";
    private final String FRAG_TAG_FAVORITE = "المفضلة";
    private final String FRAG_TAG_REVIEWS = "المراجعات";
    private final String FRAG_TAG_SUPPORT = "الاتصال بنا";
    private final String FRAG_TAG_ORDERS = "طلباتي";
    private final String FRAG_TAG_DETAILS = "التفاصيل";
    ...
    private void confirmLogout() {
        ...
        alertDialogBuilder.setMessage(getString(R.string.logout_ask));
